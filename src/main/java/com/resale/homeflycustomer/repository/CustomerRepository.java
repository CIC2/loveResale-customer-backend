...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
    ...
    @Query("""
    SELECT new com.resale.homeflycustomer.components.customer.dto.CustomerPhoneDTO(c.id, c.mobile)
    FROM Customer c
    ...
    @Query("SELECT new com.resale.homeflycustomer.components.customer.dto.CustomerFcmToken(c.id, c.fcmToken) " +
